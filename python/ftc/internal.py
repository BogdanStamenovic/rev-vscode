...
class UserConfigurationType(ConfigurationType):
    ...
    @overload
    def __init__(self, clazz: type[object], flavor: ConfigurationType.DeviceFlavor, xmlTag: str, classSource: ConfigurationTypeManager.ClassSource) -> None:
        ...
    @overload
    def __init__(self, flavor: ConfigurationType.DeviceFlavor) -> None:
        ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
...
class InstantiableUserConfigurationType(UserConfigurationType):
    ...
    @overload
    def __init__(self, clazz: type[object], flavor: ConfigurationType.DeviceFlavor, xmlTag: str, allowableConstructorPrototypes: list[ConstructorPrototype], classSource: ConfigurationTypeManager.ClassSource) -> None:
        ...
    @overload
    def __init__(self, flavor: ConfigurationType.DeviceFlavor) -> None:
        ...
...
class VectorF:
    ...
    def dimensionsError(length: int) -> Any:
        ...
    @staticmethod
    def dimensionsError(*args: Any, **kwargs: Any) -> Any:
        ...
...
class ServoType:
    ...
    __java__ = "com.qualcomm.robotcore.hardware.configuration.annotations.ServoType"
    def __init__(self, *, flavor: ServoFlavor, usPulseLower: float, usPulseUpper: float, usPulseFrameRate: float, xmlTag: str = 'Servo') -> None:
        ...
...
class ExpansionHubMotorControllerPositionParams:
    ...
    __java__ = "com.qualcomm.robotcore.hardware.configuration.ExpansionHubMotorControllerPositionParams"
...
class ExpansionHubPIDFPositionParams:
    ...
    __java__ = "com.qualcomm.robotcore.hardware.configuration.annotations.ExpansionHubPIDFPositionParams"
    def __init__(self, *, P: float, algorithm: MotorControlAlgorithm) -> None:
        ...
    def __call__(self, target: type[_AnnotationTargetT]) -> type[_AnnotationTargetT]:
        return target


class ExpansionHubPIDFVelocityParams:
    ...
    __java__ = "com.qualcomm.robotcore.hardware.configuration.annotations.ExpansionHubPIDFVelocityParams"
    def __init__(self, *, P: float, I: float = 0, D: float = 0, F: float = 0, algorithm: MotorControlAlgorithm) -> None:
        ...
    def __call__(self, target: type[_AnnotationTargetT]) -> type[_AnnotationTargetT]:
        return target
...
class CameraCalibration(CameraIntrinsics):
    ...
    def getAspectRatio(size: Size) -> float:
        ...
    @staticmethod
    def getAspectRatio(*args: Any, **kwargs: Any) -> Any:
        ...

    @overload
    @staticmethod
    def getDiagonal() -> float:
        ...
    @overload
    @staticmethod
    def getDiagonal(size: Size) -> float:
        ...
    @staticmethod
    def getDiagonal(*args: Any, **kwargs: Any) -> Any:
        ...
...
class MotorType:
    __java__ = "com.qualcomm.robotcore.hardware.configuration.MotorType"
    def __init__(self, *, xmlTag: str, name: str, ticksPerRev: float, gearing: float, maxRPM: float, achieveableMaxRPMFraction: float = 0.85, orientation: Rotation) -> None:
        ...
    def __call__(self, target: type[_AnnotationTargetT]) -> type[_AnnotationTargetT]:
        return target
...
class DistributorInfo:
    ...
    __java__ = "com.qualcomm.robotcore.hardware.configuration.DistributorInfo"
    def __init__(self, *, distributor: str = '', model: str = '', url: str = '') -> None:
        ...
    def __call__(self, target: type[_AnnotationTargetT]) -> type[_AnnotationTargetT]:
        return target
...
class MotorType:
    ...
    __java__ = "com.qualcomm.robotcore.hardware.configuration.annotations.MotorType"
    def __init__(self, *, ticksPerRev: float, gearing: float, maxRPM: float, achieveableMaxRPMFraction: float = 0.85, orientation: Rotation) -> None:
        ...
    def __call__(self, target: type[_AnnotationTargetT]) -> type[_AnnotationTargetT]:
        return target
...
class LynxUsbDeviceConfiguration(ControllerConfiguration[RhspModuleConfiguration]):
...
class LynxI2cConfigureChannelCommand(LynxDekaInterfaceCommand):
...
class DeviceProperties:
    ...
    __java__ = "com.qualcomm.robotcore.hardware.configuration.annotations.DeviceProperties"
    def __init__(self, *, xmlTag: str, name: str, description: str = '', builtIn: bool = False, defaultDevice: bool = True, compatibleControlSystems: list[ControlSystem], xmlTagAliases: list[str]) -> None:
        ...
    def __call__(self, target: type[_AnnotationTargetT]) -> type[_AnnotationTargetT]:
        return target
...
class I2cSensor:
    __java__ = "com.qualcomm.robotcore.hardware.configuration.I2cSensor"
    def __init__(self, *, xmlTag: str = '', name: str = '', description: str = 'an I2c sensor') -> None:
        ...
    def __call__(self, target: type[_AnnotationTargetT]) -> type[_AnnotationTargetT]:
        return target
...
class ExpansionHubMotorControllerVelocityParams:
    """When ExpansionHubMotorControllerVelocityParams annotations are placed on a motor type, the indicated PID coefficients are automatically initialized when instances of that motor are used."""
    __java__ = "com.qualcomm.robotcore.hardware.configuration.ExpansionHubMotorControllerVelocityParams"
    def __init__(self, *, P: float, I: float, D: float) -> None:
        ...
    def __call__(self, target: type[_AnnotationTargetT]) -> type[_AnnotationTargetT]:
        return target
