/*
 * Simulator stand-in for the FTC SDK 11.2.0 BHI260IMU (the Control Hub's IMU since
 * September 2022). The real driver talks to the chip over I2C and hands the raw
...
public class BHI260IMU implements IMU {
    ...
    @Override public String getDeviceName() { return "BHI260 IMU"; }
